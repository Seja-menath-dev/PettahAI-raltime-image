...
const DEFAULT_PROMPT =
  "A cinematic shot of a baby meerkat wearing an intricate italian priest robe. with gree grass";
      ...
      <div className="flex flex-col justify-between h-[calc(100vh-56px)]">
        <div className="py-4 md:py-10 px-0 space-y-4 lg:space-y-8 mx-auto w-full max-w-xl">
          ...
          <div className="container flex flex-col space-y-6 lg:flex-row lg:space-y-0 p-3 md:p-0">
            <div className="flex-1 flex-col flex items-center justify-center rounded-[20px]">
              {image && inferenceTime && (
                <div className="flex flex-row space-x-1 text-sm w-full mb-2  p-5">
                  <span className="text-black-500">Inference time:</span>
                  <span
                    className={
                      !inferenceTime ? "text-neutral-500" : "text-gray-250"
                    }>
                    {inferenceTime
              ...
              <div className="md:min-h-[512px] max-w-fit rounded-[20px]">
                {image && (
                  <img
                    id="imageDisplay"
                    src={image}
                    alt="Pettah ai images"
                    className="rounded-[40px] transition-transform duration-300 hover:scale-105"
                  />
                )}
              </div>
            </div>
        ...
        <div className="container flex flex-col items-center justify-center">
          <div className="flex flex-row items-center">
            <span className="text-xs font-mono">Powered by pettah ai</span>
            <span className="text-xs font-mono p-10"></span>
          </div>
        </div>
      </div>
    </main>
